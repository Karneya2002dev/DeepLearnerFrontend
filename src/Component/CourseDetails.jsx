...
//           "https://deeplearnerbackend-production-9217.up.railway.app/api/courses"
//         );
//         setCourses(res.data);
//       } catch (err) {
    ...
    >
      ...
      <div className="relative">
        <img
          ...
          alt={course.title}
          className={`w-full h-48 object-cover ${course.comingSoon ? "opacity-70 grayscale" : ""}`}
        />
...
const CoursesSection = () => {
  const courses = useSelector((state) => state.courses.courses); // ✅ Redux store
  const [filter, setFilter] = useState("All Courses");
