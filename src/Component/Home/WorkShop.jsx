...
//   useEffect(() => {
//     fetch("https://deeplearnerbackend-production-9217.up.railway.app/api/workshops")
//       .then((res) => res.json())
//       .then((data) => {
...
//     try {
//       const res = await fetch("https://deeplearnerbackend-production-9217.up.railway.app/api/register", {
//         method: "POST",
